...
=======
    // fMiner is true when called from the internal kotocoin miner
>>>>>>> a2274fe58afc6164bc15f959ba398d11bcb0cc3f
...
=======
        const char* pszTimestamp = "Traditionaly one puts something timely here coinciding with the epoch";
>>>>>>> a2274fe58afc6164bc15f959ba398d11bcb0cc3f
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
