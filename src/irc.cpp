...
=======
            Send(hSocket, "JOIN #kotocoinTEST3\r");
            Send(hSocket, "WHO #kotocoinTEST3\r");
        } else {
            // randomly join #kotocoin00-#kotocoin99
            int channel_number = GetRandInt(100);
            channel_number = 0; // Litecoin: for now, just use one channel
            Send(hSocket, strprintf("JOIN #kotocoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #kotocoin%02d\r", channel_number).c_str());
