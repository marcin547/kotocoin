...
=======
                  "  kotocoin [options]                     " + "\n" +
                  "  kotocoin [options] <command> [params]  " + _("Send command to -server or kotocoin") + "\n" +
                  "  kotocoin [options] help                " + _("List commands") + "\n" +
                  "  kotocoin [options] help <command>      " + _("Get help for a command") + "\n";
...
=======
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "kotocoin:"))
>>>>>>> a2274fe58afc6164bc15f959ba398d11bcb0cc3f
                fCommandLine = true;
...
=======
        "  -conf=<file>           " + _("Specify configuration file (default: kotocoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: kotocoin.pid)") + "\n" +
>>>>>>> a2274fe58afc6164bc15f959ba398d11bcb0cc3f
...
=======
    // Make sure only a single kotocoin process is using the data directory.
>>>>>>> a2274fe58afc6164bc15f959ba398d11bcb0cc3f
...
=======
    // requested to kill kotocoin-qt during the last operation. If so, exit.
>>>>>>> a2274fe58afc6164bc15f959ba398d11bcb0cc3f
